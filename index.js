...
document.getElementById("ReactionTimeTestPage").addEventListener("click", ()=> {
	if(state === 0) {
		state++;
		...
		document.getElementById("ReactionTimeTestPage").innerHTML = `Your reaction time is ${Date.now() - startclick}`;
